...
public class MediaPlayer extends VLCObject<MediaPlayer.Event> {
    ...
    public void play() {
        ...
        Log.d(TAG, "Begin to nativePlay ++");
        nativePlay();
        Log.d(TAG, "nativePlay done --");
    }
    ...
    public boolean setAudioTrack(int index) {
        Log.d(TAG, "Begin to nativeSetAudioTrack ++");
        boolean retval = nativeSetAudioTrack(index);
        Log.d(TAG, "nativeSetAudioTrack done --");
        return retval;
    }
    ...
    protected void onReleaseNative() {
        Log.d(TAG, "onReleaseNative");
        if (mMedia != null)
            mMedia.release();
        Log.d(TAG, "Begin to nativeRelease ++");
        nativeRelease();
        Log.d(TAG, "nativeRelease done --");
    }
